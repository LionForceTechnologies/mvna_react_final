...
export const menuadd = (drag) => {
  ...
  return (dispatch) => {
    axios.post('http://localhost:3002/api/admin/menu', {
      menu: drag.menu,
      place: drag.place,
      url: drag.url,
      serial: drag.serial,
      ...
      axios.get('http://localhost:3002/api/admin/menu?items_per_page=&current_page_no=&search=&status_connection=1').then((res) => {
...
export const menuedit = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/menu/${data}/edit`).then((res) => {
...
export const checksubmenu = (data) => {
  return (dispatch) => {
    if (data == '') {
      ...
      axios.get(`http://localhost:3002/api/admin/checkmenu?id=${data}`).then((res) => {
...
export const menudelete = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/menu/${data.id}/${data.status}`).then(({ res }) => {
      axios.get('http://localhost:3002/api/admin/menu?items_per_page=&current_page_no=&search=&status_connection=1').then((res) => {
        dispatch({ type: 'menuadd', payload: res.data.data });
...
export const submenuadd = (drag) => {
  return (dispatch) => {
    axios.post('http://localhost:3002/api/admin/menu', {
      ...
      axios.get('http://localhost:3002/api/admin/submenu?items_per_page=&current_page_no=&search=').then((res) => {
...
export const putpage = (data) => {
  return (dispatch) => {
    ...
    axios.post('http://localhost:3002/api/admin/final_content', data.havedata == 0 ? {
      "menu_id": data.id,
      ...
      axios.get(`http://localhost:3002/api/admin/final_content/${data.id}/edit`).then((res) => {
...
// export const putpage = (data) => {
//   return (dispatch) => {
//     axios.post('http://localhost:3002/api/admin/custom_create',
//       data.havedata == 0 ? {
//         "menu_id": data.id,
//         "web_html": data.webHTML,
//         "web_css": data.webCss,
...
//   }
// };
// http://localhost:3002/api/admin/final_content/91/edit
// http://localhost:3002/api/admin/final_content/${data}/edit
export const getpage = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/final_content/${data}/edit`, {
      headers: {
        "Access-Control-Allow-Origin": "*"
      }
    }).then((res) => {
...
export const putrole = (data) => {
  return (dispatch) => {
    axios.post('http://localhost:3002/api/admin/role',
      {
        "role": data.role,
      }
    ).then((res) => {
      axios.get('http://localhost:3002/api/admin/role?items_per_page=&current_page_no=&search=&status_connection=1').then((res) => {
        dispatch({
          type: 'getrole',
...
export const roleedit = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/role/${data}/edit`).then((res) => {
      dispatch({
        type: 'roledit',
        payload: res.data
      })
...
export const roledelete = (data) => {
  ...
  console.log(data)
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/role/${data.id}/${data.status}`).then((res) => {
      dispatch({
        type: 'deleted',
        payload: 'success'
      })
...
// }
  ...
  return (dispatch) => {
    axios.post('http://localhost:3002/api/admin/member', 
      formData      
    ).then((res) => {
      axios.get('http://localhost:3002/api/admin/member?items_per_page=&current_page_no=&search=&status_connection=1').then((res) => {
        dispatch({
          type: 'getmember',
          payload: res.data.data
        })
...
export const getmemberweb = (data) => {
  return (dispatch) => {
    axios.get('http://localhost:3002/api/member?items_per_page=&current_page_no=&search=&status_connection=1').then((res) => {
      dispatch({
        type: 'getmember_web',
        payload: res.data.data
      })
...
export const editmember = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/member/${data}/edit`).then((res) => {
      dispatch({
        type: 'editmember',
        payload: res.data
      })
...
export const deletemember = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/member/${data.id}/${data.status}`).then((res) => {
      dispatch({
        type: 'deletedmember',
        payload: 'success'
      })
...
export const putucreation = (data) => {
  return (dispatch) => {
    ...
    axios.post('http://localhost:3002/api/auth/register', {
      ...
      axios.get('http://localhost:3002/api/admin/user?items_per_page=&current_page_no=&search=&status_connection=1').then((res) => {
        dispatch({
          type: 'getucreation',
          payload: res.data.data
        })
...
export const editucreation = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/user/${data}/edit`).then((res) => {
      dispatch({
        type: 'editucreation',
        payload: res.data
      })
...
export const deleteucreation = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/user/${data.id}/${data.status}`).then((res) => {
      dispatch({
...
export const getpagepermission = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/final_content/custom`).then((res) => {
      dispatch({
        type: 'pagepermission',
...
export const getrolepermission = (data) => {
  return (dispatch) => {
    axios.get('http://localhost:3002/api/admin/rolepermission?items_per_page=&current_page_no=&search=&status_connection=1').then((res) => {
      dispatch({
...
export const putpagepermission = (data) => {
  return (dispatch) => {
    axios.post('http://localhost:3002/api/admin/rolepermission', {
      role_id: data.role_id,
...
export const editrolepermission = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/rolepermission/${data}/edit`).then((res) => {
...
export const deletepermission = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/rolepermission/${data.id}/${data.status}`).then((res) => {
...
export const getfooter = (data) => {
  return (dispatch) => {
    axios.get('http://localhost:3002/api/admin/footer?items_per_page=10&current_page_no=1&search=&status_connection=1').then((res) => {
    dispatch({
        type: 'getfooter',
        payload: res.data
      })
...
export const putfooter = (data) => {
  return (dispatch) => {
    axios.post('http://localhost:3002/api/admin/footer',{
      addressline1 : data.addressline1,
      addressline2 : data.addressline2,
      mobile : data.mobile,
      id : 1
    }).then((res) => {
      axios.get('http://localhost:3002/api/admin/footer?items_per_page=&current_page_no=&search=&status_connection=1').then((res) => {
        dispatch({
          type: 'getfooter',
          payload: res.data
        })
...
export const putlink = (data) => {
  ...
  return (dispatch) => {
    axios.post('http://localhost:3002/api/admin/quicklink', 
    // {
    //   name: data.name,
    //   link: data.link,
    // }
    formData
      ...
      axios.get('http://localhost:3002/api/admin/quicklink?items_per_page=&current_page_no=&search=&status_connection=1').then((res) => {
        dispatch({
          type: 'getlink',
          payload: res.data.data
        })
...
export const editlink = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/quicklink/${data}/edit`).then((res) => {
      dispatch({
        type: 'editqlink',
        payload: res.data
      })
...
export const deletelink = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/quicklink/${data.id}/${data.status}`).then((res) => {
      dispatch({
        type: 'deletedlink',
        payload: 'success'
      })
...
export const getcountry = (data) => {
  return (dispatch) => {
    axios.get('http://localhost:3002/api/country').then((res) => {
      dispatch({
        type: 'getcountry',
        payload: res.data.data
      })
...
export const getmemberwebcountry = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/member?country=${data}`).then((res) => {
      dispatch({
        type: 'getmember_web',
        payload: res.data.data
      })
...
export const putfile = (data) => {
  ...
  return (dispatch) => {
    axios.post('http://localhost:3002/api/admin/fileupload', 
    formData
    
    ).then((res) => {
      axios.get('http://localhost:3002/api/admin/fileupload?items_per_page=&current_page_no=&search=&status_connection=1').then((res) => {
        dispatch({
          type: 'getfiles',
          payload: res.data.data
        })
...
export const getfileweb = (data) => {
  return (dispatch) => {
    axios.get('http://localhost:3002/api/fileupload?items_per_page=&current_page_no=&search=&status_connection=1').then((res) => {
      dispatch({
        type: 'getfilesweb',
        payload: res.data.data
      })
...
export const editfile = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/fileupload/${data}/edit`).then((res) => {
      dispatch({
        type: 'editfiles',
        payload: res.data
      })
...
export const deletefile = (data) => {
  return (dispatch) => {
    axios.get(`http://localhost:3002/api/admin/fileupload/${data.id}/${data.status}`).then((res) => {
      dispatch({
        type: 'deletedfile',
        payload: 'success'
      })
